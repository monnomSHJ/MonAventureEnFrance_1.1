...
export function getAirport4Scene() {
    ...
    return {
        ...
        lines: [
            ...
            { speaker: `👨‍✈️ Chauffeur`, text: "D'accord !", sound: "assets/sounds/module1/taxiSpeak1.wav" },
            { speaker: ``, text: `🚕🚕🚕...`},
            { speaker: ``, text: `🚕🚕🚕........`},
            { speaker: ``, text: `🚕🚕🚕..............`},
            { speaker: `👤 ${state.userName}`, text: `... 뭔가 택시 기사님이 말을 걸까봐 두렵다.`},
            { speaker: `👨‍✈️ Chauffeur`, text: `Vous venez d'où ?`, sound: "assets/sounds/module1/taxiSpeak2.wav"},
            ...
            { speaker: `👨‍✈️ Chauffeur`, text: `Ah, vous venez de Corée ? C'est un beau pays !`, sound: "assets/sounds/module1/taxiSpeak3.wav"},
            { speaker: `👨‍✈️ Chauffeur`, text: `C'est la première fois que vous venez en France ?`, sound: "assets/sounds/module1/taxiSpeak4.wav"},
            { speaker: `👤 ${state.userName}`, text: `Oui, c'est ma première fois.`},
            { speaker: `👨‍✈️ Chauffeur`, text: `Très bien. Vous parlez très bien français !`, sound: "assets/sounds/module1/taxiSpeak5.wav"},
