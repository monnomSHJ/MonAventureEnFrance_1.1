...
export function getCafe1Scene() {
    ...
    return {
        ...
        lines: [
            ...
            { speaker: `👩‍🍳 Serveuse`, text: `Qu'est ce qui vous ferez plaisir ?`, personImg: `assets/images/cafePerson1.png`, overlayImg: `assets/images/cafeMenu.png` },
            ...
            { speaker: `👩‍🍳 Serveuse`, text: `D'accrod. Comment payez vous ?`, personImg: "assets/images/cafePerson1.png" },
            { speaker: `👤 ${state.userName}`, text: `En espèces, s'il vous plaît.`, personImg: `assets/images/cafePerson1.png` },
            { speaker: `👩‍🍳 Serveuse`, text: () => `Très bien ! Ça fait ${state.selectedCafe?.price ?? "?"} euros.`, personImg: "assets/images/cafePerson1.png" },
