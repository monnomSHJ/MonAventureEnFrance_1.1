...
export function getCafe4Scene() {
    ...
    return {
        ...
        lines: [
            ...
            { speaker: `📢`, text: "문장 만들기 성공! 5점을 획득하였습니다.", personImg: "assets/images/restaurantPerson1.png"},
            { speaker: `👨‍🍳 Serveur`, text: `Qu'avez-vous oublié ?`, personImg: "assets/images/restaurantPerson1.png" , sound: "assets/sounds/module2/lostSpeak1.wav"},
            ...
            { speaker: `📢`, text: "문장 만들기 성공! 5점을 획득하였습니다.", personImg: "assets/images/restaurantPerson1.png"},
            { speaker: `👨‍🍳 Serveur`, text: `Non, il n'y a rien ici.`, personImg: "assets/images/restaurantPerson1.png", sound: "assets/sounds/module2/lostSpeak2.wav" },
            { speaker: `👨‍🍳 Serveur`, text: `Peut-être que quelqu'un l'a pris.`, personImg: "assets/images/restaurantPerson1.png", sound: "assets/sounds/module2/lostSpeak3.wav" },
