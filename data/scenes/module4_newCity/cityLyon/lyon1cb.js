...
export function getLyon1cbScene() {
    ...
    return {
        ...
        lines: [
            ...
            { speaker: `👤 Employée`, text: `D'accord. Vous devez aller à la porte numéro douze.`, personImg: `assets/images/garePerson1.png`, sound: "assets/sounds/module4/airportPaltformSpeak1.wav" },
